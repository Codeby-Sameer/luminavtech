        ...
        >
          <div className="bg-surface rounded-card p-8 sm:p-12 border border-default shadow-card space-y-8 text-body font-light leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold font-display text-heading">1. Acceptance of Terms</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold font-display text-heading">2. Provision of Services</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold font-display text-heading">3. Proprietary Rights</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold font-display text-heading">4. Limitation of Liability</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold font-display text-heading">5. Governing Law</h2>
              <p>
